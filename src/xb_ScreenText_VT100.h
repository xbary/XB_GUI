#ifndef _SCREENTEXT_VT100_h
#define _SCREENTEXT_VT100_h
...
#define VT100_LOWINTENS       "\033[2m"
#define VT100_UNDERLINE       "\033[4m"
#define VT100_BLINK           "\033[5m"
#define VT100_REVERSE         "\033[7m"

// COLORS
#define VT100_FOREGROUNDCOLOR(c)    "\033[3cm"
#define VT100_BACKGROUNDCOLOR(c)    "\033[4cm"


// POSITIONING
#define VT100_CLS             "\033[2J"      // Esc[2J Clear entire screen
#define VT100_GOTOXY(x,y)    "\033[x;yH"     // Esc[Line;ColumnH
#define VT100_HOME            "\033[H"
#define VT100_GETXY			"\033[6n"		//Esc6n 	Get cursor position 	DSR
											//EscLine; ColumnR 	Response : cursor is at v, h 	CPR
#define VT100_SHOWCURSOR	"\033[?25h"		//<ESC>[?25l - display cursor
#define VT100_HIDECURSOR	"\033[?25l"		//<ESC>[?25h - hide cursor



#define VT100_SAVECURSORPOSITION	"\0337"			// Esc7 	Save cursor position and attributes 	DECSC
#define VT100_RESTORECURSORPOSITION	"\0338"			// Esc8 	Restore cursor position and attributes 	DECSC




#define VT100_CUD(x)          "\033[xB"      // Move cursor up n lines
